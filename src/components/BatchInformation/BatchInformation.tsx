...
import BatchAverageGraph from "../BatchGraphs/BatchAverageGraph";
        ...
        <div id="batch-info-wrapper">
          <Card className="batch-info-card">
            ...
            <CardBody>
              ...
              <h5>
                <b className="readctl">Core Technology Learned:</b>
              </h5>
              <Row>
              ...
              <Row style={{ textAlign: "center" }}>
                <Col>
                  <p id="test-skill">{batch.skill}</p>
                </Col>
              </Row>
              {/* Trainer and end date text */}
              <p id="test-train">
                <b className="readtrainer">Trainer:</b> {batch.trainer}
              </p>
              <p id="test-end-date">
                <b className="readted">Training End Date:</b> {batch.endDate}
              </p>
            </CardBody>
            <CardFooter />
          </Card>
            ...
            <>
              ...
              <AssociateCardFactory
                {...Object.entries(batch).reduce(
                  (a, [k, v]) =>
                    ["employeeAssignments"].includes(k) ? a : { ...a, [k]: v },
                  {}
                )}
              />
            </>
